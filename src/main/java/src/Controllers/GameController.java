...
public class GameController {
     ...
     * @throws OperationNotAllowedException Thrown when the token passed does not have the right to do the request.
     ...
     * @throws TokenNotFoundException Thrown when the token is not found or is no longer valid.
     * @throws OperationNotAllowedException Thrown when the token does not have the right to do the request.
     */
    @PostMapping
    @CrossOrigin
    public ResponseEntity<Object> addNewGame(@RequestBody Game newGame, @RequestHeader(Auth_Token_Header) String token)
            ...
            TokenNotFoundException, OperationNotAllowedException {
        return new ResponseEntity<>(
     ...
     * @throws OperationNotAllowedException Thrown when the token does not have the rights to do the request.
     * @throws UserDoesNotExistException Thrown when the user who made the request does not exist
     */
    @PostMapping("/reports")
    @CrossOrigin
    public ResponseEntity<Object> addNewReport(@RequestBody Report newReport, @RequestHeader(Auth_Token_Header) String token)
            throws InvalidTokenException, ExecutionException, InterruptedException, TokenNotFoundException,
            GameNotFoundException, OperationNotAllowedException, UserDoesNotExistException {
        return new ResponseEntity<>(
     ...
     * @throws InterruptedException Thrown when the connection to database is interrupted.
     * @throws TokenNotFoundException Thrown when the token is not found or is no longer valid.
     * @throws OperationNotAllowedException Thrown when the token does not have the right to do request.
     */
    @GetMapping("/reports")
    public ResponseEntity<Object> getReports(@RequestBody RecordQuery recordQuery, @RequestHeader(Auth_Token_Header) String token)
            throws InvalidTokenException, ExecutionException, InterruptedException, TokenNotFoundException, OperationNotAllowedException {
        return new ResponseEntity<>(
